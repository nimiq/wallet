<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-7 -7 100 83" class="usdt">
        <path v-if="!hole" fill="#fff" d="M 19.596219,7.6270475 H 66.430976 V 44.958728 c -15.933124,8.870098 -31.518243,8.139987 -46.834757,0 z" />
