...
// https://coinify-trade-api.readme.io/reference/supported-countries-list
const COINIFY_UNSUPPORTED_COUNTRY_CODES: string[] = [
    'AE',
    'AF',
    'AG',
    'AI',
...
export const COINIFY_COUNTRY_CODES = ALL_COUNTRY_CODES
    .filter((code) => !COINIFY_UNSUPPORTED_COUNTRY_CODES.includes(code));
