...
import { IContentSpecialItem, OnboardingTourStep, ITourStepTexts } from '../types';

const t = (input: string) => i18n.t(input) as string;
...
const texts: ITourStepTexts<OnboardingTourStep> = {
    ...
    [OnboardingTourStep.ONBOARDING_COMPLETED]: {
        default: [
            ...
            'Nimiq is not just any crypto - '
            + `Click on ${IContentSpecialItem.ICON_NETWORK_WORLD} Network and discover true decentralization.`,
        ],
    },
};
